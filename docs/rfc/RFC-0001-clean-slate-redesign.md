...
| Frameworks       | Zod v4, graphology (+`graphology-dag`), commander, `@modelcontextprotocol/sdk`, Vite/React 19, Vitest 4, Playwright                             | Already in use; retained (see §11 Alternatives)                                                                                                                                                                                                                                    |
