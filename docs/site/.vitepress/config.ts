...
export default defineConfig({
  vite: {
    build: {
      // esbuild >=0.27 dropped downleveling for old browser targets; use modern
      // baseline to avoid "Transforming destructuring not supported yet" errors.
      target: "es2022",
    },
  },
  lang: "en-US",
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        "https://github.com/yu-iskw/dbt-tools-ts/edit/main/docs/site/:path",
