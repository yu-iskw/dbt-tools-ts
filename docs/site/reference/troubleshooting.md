...
| Remote S3/GCS errors                                | Credentials or path on server          | Configure env on **Node** (CLI/MCP/web server), not in browser; see [Local-first and remote artifacts](../concepts/local-and-remote-artifacts.md) |
