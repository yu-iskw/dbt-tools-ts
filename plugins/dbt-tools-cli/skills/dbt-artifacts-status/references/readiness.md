...
| --------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `full`          | `summary`, `graph`, `deps`, `inventory`, `search`, `timeline`, `query-executions`, `run-summary`, `status` | —                                                                                                                          |
| `manifest-only` | `summary`, `graph`, `deps`, `inventory`, `search`, `status`                                                | `timeline`, `query-executions`, `run-summary` (require `run_results.json`)                                                 |
| `unavailable`   | `status` (and `freshness` alias)                                                                           | `summary`, `graph`, `deps`, `inventory`, `search`, `timeline`, `query-executions`, `run-summary` (require `manifest.json`) |
