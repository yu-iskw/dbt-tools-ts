...
- **Dev tools (mise):** optional search CLIs in [`mise.toml`](mise.toml) — `mise trust` then `mise install`. **Coding agents:** use [`.claude/skills/codebase-search/SKILL.md`](.claude/skills/codebase-search/SKILL.md) (`fd` → files, `rg` → contents, `sg` → AST); complements, does not replace, quality gates.
...
Optional dev search tools ([`codebase-search` skill](.claude/skills/codebase-search/SKILL.md)): `mise trust && mise install`.
...
- Codebase exploration (fd, rg, sg): [`.claude/skills/codebase-search/SKILL.md`](.claude/skills/codebase-search/SKILL.md).
