...
/**
 * The MCP server skips output-schema validation when result.isError is true.
 * Tool errors still use toolErrorSchema in structuredContent for clients that read it.
 */
