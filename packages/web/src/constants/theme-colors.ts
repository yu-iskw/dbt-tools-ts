...
export function getThemeHex(theme: ThemeMode): typeof THEME_HEX_DARK | typeof THEME_HEX_LIGHT {
...
export function getCanvasColors(theme: ThemeMode): typeof CANVAS_DARK | typeof CANVAS_LIGHT {
