...
- **Gate vs investigation:** Both live in [`status`](../../../../plugins/dbt-tools-cli/skills/status/SKILL.md) (Readiness gate + Investigation sections); command matrix stays in [`status/references/readiness.md`](../../../../plugins/dbt-tools-cli/skills/status/references/readiness.md).
